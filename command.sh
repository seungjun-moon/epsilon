...
python main_demo.py --vis_type capture --frame_id 0 --model_path exps/snapshot/male-3-casual/hybrid --ero --eio

CUDA_VISIBLE_DEVICES=0 python main_demo.py --vis_type animate \
--model_path exps/snapshot/male-3-casual/hybrid --animation_file 'data/pixie_radioactive.pkl' --ero --eio