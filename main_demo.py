...
if __name__ == '__main__':
    ...
    data_cfg = os.path.join(model_dir, 'config.yaml')
    if os.path.isfile(os.path.join(model_dir,'exp_config.yaml')):
        cfg_file = os.path.join(model_dir,'exp_config.yaml')
    else:
        cfg_file = 'configs/exp/single.yml'
